...
@Component({
  selector: 'app-tickets-por-agente',
  templateUrl: './tickets-por-agente.component.html',
  styleUrls: ['./tickets-por-agente.component.css']
})
export class TicketsPorAgenteComponent implements OnInit {
    ...
    titulopant : string = "Tickets por Agente";
    ...
    loadDataProceso() {
      ...
      this.api.getticketsxfxa(data_post).subscribe({
        next: (data: any[]) => {
